...
exports.deobf_rules = {
	...
	"core-js/meta.js":{ duplicates: 3, rule: `if(!o(t,r)){if(!s(t))return!0;if(!e)return!1;l(t)}`},
	"core-js/is-object.js": { duplicates: 3, rule: `module.exports=function(t){return"object"==typeof t?null!==t:"function"==typeof t}` },
	"core-js/has.js":{ duplicates: 3, rule: `var n={}.hasOwnProperty;module.exports=function(t,e){return n.call(t,e)}`},
	"core-js/object-dp.js":{ duplicates: 3, rule: `if(r(t),e=o(e,!0),r(n),i)try{return a(t,e,n)}catch(t){}if("get"in n||"set"in n)throw TypeError("Accessors not supported!");`},
	"core-js/fails.js":{ duplicates: 3, rule: `module.exports=function(t){try{return!!t()}catch(t){return!0}}`},
	"core-js/export.js":{ duplicates: 2, rule:`{var c,l,f,d,p=t&s.F,h=t&s.G,v=t&s.S,y=t&s.P,m=t&s.B,g=h?r:v?r[e]||`},
	"core-js/ctx.js":{ duplicates: 3, rule:`(t,e,n){if(r(t),void 0===e)return t;switch(n){case 1:return function(n){return t.call(e,n)};case 2:`},
	"core-js/global.js":{ duplicates: 3, rule:`"undefined"!=typeof self&&self.Math==Math?self:Function("return this")();`},
	"core-js/core.js":{ duplicates: 2, rule:`{version:"2.5.3"};"number"==typeof __e&&(__e=n)`},
	"core-js/hide.js":{ duplicates: 3, rule:`function(t,e,n){return r.f(t,e,i(1,n))}:function(t,e,n){return t[e]=n,t}`},
	"core-js/redefine.js":{ duplicates: 2, rule:`i(n,a,t[e]?""+t[e]:s.join(String(e)))),t===r?t[e]=n:u?t[e]?t[e]=n:i(t,e,n):`},
	"core-js/property-desc.js":{ duplicates: 3, rule:`{enumerable:!(1&t),configurable:!(2&t),writable:!(4&t),value:e}}`},
	"core-js/descriptors.js":{ duplicates: 3, rule:`(function(){return 7!=Object.defineProperty({},"a",{get:function(){return 7}}).a})`},
	"core-js/uid.js":{ duplicates: 3, rule:`=function(t){return"Symbol(".concat(void 0===t?"":t,")_",(++n+r).toString(36))}`},
	"core-js/typed-array.js":{ duplicates: 1, rule:`lt.call(St(this),t)},subarray:function(t,e){var n=St(this),r`},
	"core-js/library.js":{ duplicates: 2, rule:`module.exports=!1`},
	"core-js/typed.js":{ duplicates: 1, rule:`module.exports={ABV:c,CONSTR:l,TYPED:u,VIEW:s}`},
	"core-js/typed-buffer.js":{ duplicates: 1, rule:`,exports.ArrayBuffer=b,exports.DataView=w`},
	"core-js/an-instance.js":{ duplicates: 3, rule:`throw TypeError(n+": incorrect invocation!");`},
	"core-js/redefine-all.js":{ duplicates: 2, rule:`module.exports=function(t,e,n){for(var i in e)r(t,i,e[i],n);return t}`},
	"core-js/to-integer.js": { duplicates: 3, rule: `module.exports=function(t){return isNaN(t=+t)?0:(` },
	"core-js/to-length.js": { duplicates: 3, rule: ` t>0?i(r(t),9007199254740991):0`}, // number is negative -> return 0, number is positive -> return number

	"core-js/to-index.js":{ duplicates: 1, rule:`return 0;var e=r(t),n=i(e);if(e!==n)throw RangeError("Wrong length!");return n}`},
	"core-js/to-primitive.js":{ duplicates: 3, rule:`function(t,e){return(t=r(t))<0?i(t+e,0):o(t,e)}`},
	// "core-js/has.js":{ duplicates: 2, rule:`n.call(t)))return i;throw TypeError("Can't convert object to primitive value")}`},
	"core-js/object-gopd.js":{ duplicates: 3, rule:`),s)try{return c(t,e)}catch(t){}if(u(t,e))return i(!r.f.call(t,e),t[e])}`},
	"core-js/array-copy-within.js":{ duplicates: 1, rule:`,s+=l-1,u+=l-1);l-- >0;)s in n?n[u]=n[s]:delete n[u],u+=f,s+=f;return n}`},
	"core-js/array-fill.js":{ duplicates: 1, rule:`arguments[2]:void 0,c=void 0===s?n:i(s,n);c>u;)e[u++]=t;return e}`},
	"core-js/set-species.js":{ duplicates: 2, rule:`e&&!e[a]&&i.f(e,a,{configurable:!0,get:function(){return this}})}`},
	"core-js/iter-select.js":{ duplicates: 3, rule:`.next=function(){return{done:n=!0}},o[r]=function(){return a},t(o)}catch(t){}return n}`},
	"core-js/wks.js":{ duplicates: 3, rule:`t){return r[t]||(r[t]=a&&o[t]||(a?o:i)("Symbol."+t))}).store=r`},
	"core-js/array-methods.js":{ duplicates: 3, rule:`5:return v;case 6:return w;case 2:x.push(v)}else if(l)return!1;return f?-1:c||l?l:x}}`},
	"core-js/array-includes.js":{ duplicates: 3, rule:`)!=u)return!0}else for(;c>l;l++)if((t||l in s)&&s[l]===n)return t||l||0;return!t&&-1}}`},
	"core-js/species-constructor.js":{ duplicates: 3, rule:`{var n,a=r(t).constructor;return void 0===a||void 0==(n=r(a)[o])?e:i(n)}`},
	"core-js/es6.array.iterator.js":{ duplicates: 3, rule:`?t[n]:[n,t[n]])},"values"),o.Arguments=o.Array,r("keys"),r("values"),r("entries")`},
	"core-js/iterators.js":{ duplicates: 5, rule:`module.exports={}`},
	"core-js/to-object.js":{ duplicates: 3, rule:`;module.exports=function(t){return Object(r(t))}`},
	"core-js/is-array-iter.js":{ duplicates: 3, rule:`,o=Array.prototype;module.exports=function(t){return void 0!==t&&(r.Array===t||o[i]===t)}`},
	"core-js/object-create.js": { duplicates: 3, rule: `exports=Object.create||function` },
	"core-js/object-gpo.js": { duplicates: 3, rule: `exports=Object.getPrototypeOf||function` },
	"core-js/object-gopn.js":{ duplicates: 3, rule:`exports.f=Object.getOwnPropertyNames||function(t){return r(t,i)}`},
	...
	"core-js/same-value.js":{ duplicates: 3, rule:`catch(t){}}(e=Object(t),i))?n:o?r(e):"Object"==(a=r(e))&&"function"==typeof e.callee?"Arguments":a}`},
	// "core-js/redefine.js":{ duplicates: 2, rule:``},
	// "core-js/redefine.js":{ duplicates: 2, rule:``},
	// "core-js/redefine.js":{ duplicates: 2, rule:``},
	// "core-js/redefine.js":{ duplicates: 2, rule:``},
	// "core-js/redefine.js":{ duplicates: 2, rule:``},
	...
	"services/TwitterUser.js": `exports=TD.services.TwitterUser=function(e)`,
	...
	"twitter-text/regexen/astralLetterAndMarks.js": `\\ud84b[\\udc00-\\udfff]|\\ud84c[\\udc00-\\udfff]|\\ud84d[\\udc00-\\udfff]|\\ud84e[\\udc00-\\udfff]|\\ud84f[\\udc00-\\udfff]|\\ud850`,
	"twitter-text/regexen/astralNumerals.js": `\\ud801[\\udca0-\\udca9]|\\ud804[\\udc66-\\udc6f\\udcf0-\\udcf9\\udd36-\\udd3f\\uddd0-\\uddd9\\udef0-\\udef9]`,
	"twitter-text/regexen/atSigns.js": `/[@＠]/`,
	"twitter-text/regexen/bmpLetterAndMarks.js": `A-Za-z\\xaa\\xb5\\xba\\xc0-\\xd6\\xd8`,
	"twitter-text/regexen/bmpNumerals.js": `0-9\\u0660-\\u0669\\u06f0-\\u06f9\\u07c0-\\u07c9`,
	"twitter-text/regexen/cashtag.js": `[a-z]{1,6}(?:[._][a-z]{1,2})?`,
	"twitter-text/regexen/codePoint.js": `(?:[^\\uD800-\\uDFFF]|[\\uD800-\\uDBFF][\\uDC00-\\uDFFF])`,
	"twitter-text/regexen/cyrillicLettersAndMarks.js": `/\\u0400-\\u04FF/`,
	"twitter-text/regexen/endHashtagMatch.js": `/^(?:#{hashSigns}|:\\/\\/)/,`,
	"twitter-text/regexen/endMentionMatch.js": `?:#{atSigns}|[#{latinAccentChars}]`,
	"twitter-text/regexen/extractUrl.js": `((#{validUrlPrecedingChars})((https?:`,
	"twitter-text/regexen/hashSigns.js": `/[#＃]/`,
	"twitter-text/regexen/hashtagAlpha.js": `(?:[#{bmpLetterAndMarks}]|`,
	"twitter-text/regexen/hashtagAlphaNumeric.js": `[#{bmpLetterAndMarks}#{bmpNumerals}#{hashtagSpecialChars}]|(?=#{nonBmpCodePairs})(?:#{astralLetterAndMarks}|#{astralNumerals})`,
	"twitter-text/regexen/hashtagBoundary.js": `?:^|\\uFE0E|\\uFE0F|$|`,
	"twitter-text/regexen/hashtagSpecialChars.js": `\\u200c\\u200d\\ua67e\\u05be\\u05f3\\u05f4\\uff5e\\u301c\\u309b\\u309c\\u30a0\\u30fb\\u3003\\u0f0b\\u0f0c\\xb7`,
	"twitter-text/regexen/invalidChars.js": `.default)(/[#{invalidCharsGroup}]/`,
	"twitter-text/regexen/invalidCharsGroup.js": `exports.default=/\\uFFFE\\uFEFF\\uFFFF/`,
	"twitter-text/regexen/invalidDomainChars.js": `#{punct}#{spacesGroup}#{invalidCharsGroup}#{directionalMarkersGroup}`,
	"twitter-text/regexen/invalidUrlWithoutProtocolPrecedingChars.js": `exports.default=/[-_.\\/]$/`,
	"twitter-text/regexen/latinAccentChars.js": `\\xC0-\\xD6\\xD8-\\xF6\\xF8-\\xFF\\u0100-\\u024F\\u0253\\u0254\\u0256\\u0257\\u0259\\u025B\\u0263\\u0268\\u026F\\u0272\\u0289\\u028B\\u02BB\\u0300-\\u036F\\u1E00`,
	"twitter-text/regexen/nonBmpCodePairs.js": `/[\\uD800-\\uDBFF][\\uDC00-\\uDFFF]/gm`,
	"twitter-text/regexen/punct.js": `/\\!'#%&'\\(\\)*\\+,\\\\\\-\\.\\/:;<=>\\?@\\[\\]\\^_{|}~\\$/`,
	"twitter-text/regexen/rtl_chars.js": `[\\u0600-\\u06FF]|[\\u0750-\\u077F]|[\\u0590-\\u05FF]|[\\uFE70-\\uFEFF]`,
	"twitter-text/regexen/spaces.js": `.default)(/[#{spacesGroup}]/`,
	"twitter-text/regexen/spaces_group.js": `\\x09-\\x0D\\x20\\x85\\xA0\\u1680\\u180E\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000`,
	"twitter-text/regexen/urlHasHttps.js": `/^https:\\/\\//i`,
	"twitter-text/regexen/urlHasProtocol.js": `/^https?:\\/\\//i`,
	"twitter-text/regexen/validAsciiDomain.js": `(?:[0-9]|(?:[1-9][0-9])|(?:1[0-9]{2})|(?:2[0-4][0-9])|(?:25[0-5]))/`,
	// "twitter-text/regexen/validateUrlAuthority.js": ``,
	"twitter-text/regexen/validateUrlDecOctet.js": `/(?:(?:#{validateUrlSubDomainSegment}\\.)*(?:#{validateUrlDomainSegment}\\.)#{validateUrlDomainTld})/i`,
	"twitter-text/regexen/validateUrlDomain.js": `/(?:[a-z0-9](?:[a-z0-9\\-]*[a-z0-9])?)/i`,
	"twitter-text/regexen/validateUrlDomainSegment.js": `/(?:[a-z](?:[a-z0-9\\-]*[a-z0-9])?)/i`,
	"twitter-text/regexen/validateUrlDomainTld.js": `.default)(/(#{validateUrlPchar}|\\/|\\?)*/i`,
	"twitter-text/regexen/validateUrlFragment.js": `.default)("(?:#{validateUrlIp}|#{validateUrlDomain})",`,
	"twitter-text/regexen/validateUrlHost.js": `.default)("(?:#{validateUrlIpv4}|#{validateUrlIpv6})"`,
	"twitter-text/regexen/validateUrlIp.js": `.default)(/(?:#{validateUrlDecOctet}(?:\\.#{validateUrlDecOctet}){3})/i`,
	"twitter-text/regexen/validateUrlIpv4.js": `/(?:\\[[a-f0-9:\\.]+\\])/i`,
	"twitter-text/regexen/validateUrlIpv6.js": `.default)(/(\\/#{validateUrlPchar}*)*/i`,
	"twitter-text/regexen/validateUrlPath.js": `.default)("(?:#{validateUrlUnreserved}|#{validateUrlPctEncoded}|#{validateUrlSubDelims}|[:|@])"`,
	"twitter-text/regexen/validateUrlPchar.js": `/(?:%[0-9a-f]{2})/i`,
	"twitter-text/regexen/validateUrlPctEncoded.js": `.default=/[0-9]{1,5}/`,
	"twitter-text/regexen/validateUrlPort.js": `.default)(/(#{validateUrlPchar}|\\/|\\?)*/i`,
	"twitter-text/regexen/validateUrlQuery.js": `.default=/(?:[a-z][a-z0-9+\\-.]*)/i`,
	"twitter-text/regexen/validateUrlScheme.js": `.default=/[!$&'()*+,;=]/i`,
	"twitter-text/regexen/validateUrlSubDelims.js": `/(?:[a-z0-9](?:[a-z0-9_\\-]*[a-z0-9])?)/i`,
	"twitter-text/regexen/validateUrlSubDomainSegment.js": `("^(?:([^:/?#]+):\\\\/\\\\/)?([^/?#]*)([^?#]*)(?`,
	"twitter-text/regexen/validateUrlUnencoded.js": `"(?:(#{validateUrlUserinfo})@)?(#{validateUrlUnicodeHost})(?::(#{validateUrlPort}))?"`,
	"twitter-text/regexen/validateUrlUnicodeAuthority.js": `.default)(/(?:(?:#{validateUrlUnicodeSubDomainSegment}`,
	"twitter-text/regexen/validateUrlUnicodeDomain.js": `(?:(?:[a-z0-9]|[^\\u0000-\\u007f])(?:(?:[a-z0-9\\-]|[^\\u00`,
	"twitter-text/regexen/validateUrlUnicodeDomainSegment.js": `exports.default=/(?:(?:[a-z0-9]|[^\\u0000-\\u007f])(?:(?:[a-z0-9\\-]|[^\\u0000-\\u007f])*(?:[a-z0-9]|[^\\u0000-\\u007f]))?)/i,module.exports=exports.default`,
	"twitter-text/regexen/validateUrlUnicodeDomainTld.js": `.default)("(?:#{validateUrlIp}|#{validateUrlUnicodeDomain})"`,
	"twitter-text/regexen/validateUrlUnicodeHost.js": `/(?:(?:[a-z0-9]|[^\\u0000-\\u007f])(?:(?:[a-z0-9`,
	"twitter-text/regexen/validateUrlUnicodeSubDomainSegment.js": `.default=/[a-z\\u0400-\\u04FF0-9\\-._~]/i`,
	"twitter-text/regexen/validateUrlUnreserved.js": `.default)("(?:#{validateUrlUnreserved}|#{validateUrlPctEncoded}|#{validateUrlSubDelims}|:)*"`,
	"twitter-text/regexen/validateUrlUserinfo.js": `/(?:(?:[\\-a-z0-9#{latinAccentChars}]+)\\.)+(?:#{validGTLD}|#{validCCTLD}|#{validPunycode})/gi`,
	"twitter-text/regexen/validCashtag.js": `.default)("(^|#{spaces})(\\\\$)(#{cashtag})(?=$|\\\\s|[#{punct}])"`,
	"twitter-text/regexen/validCCTLD.js": `"(?:(?:한국|香港|澳門|新加坡|台灣|台湾|中國|中国|გე|ไทย|ලංකා|ഭാരതം|ಭಾರತ|భారత్|சிங்கப்பூர்|இலங்கை|இந்தியா|ଭାରତ|ભારત|ਭਾਰਤ|ভাৰত|ভারত|বাংলা|भारोत|भारतम्|भारत|ڀارت|پاکستان|موريتانيا|مليسيا|مصر|قطر|فلسطين|عمان|عراق|سورية|سودان|تونس|بھارت|بارت|ایران|امارات|المغرب|السعودية|الجزائر|الاردن|հայ|қаз|укр|срб|рф|мон|мкд|ею|бел|бг|ελ|zw|zm|za|yt|ye|ws|wf|vu|vn|vi|vg|ve|vc|va|uz|uy|us|um|uk|ug|ua|tz|tw|tv|tt|tr|tp|to|tn|tm|tl|tk|tj|th|tg|tf|td|tc|sz|sy|sx|sv|su|st|ss|sr|so|sn|sm|sl|sk|sj|si|sh|sg|se|sd|sc|sb|sa|rw|ru|rs|ro|re|qa|py|pw|pt|ps|pr|pn|pm|pl|pk|ph|pg|pf|pe|pa|om|nz|nu|nr|np|no|nl|ni|ng|nf|ne|nc|na|mz|my|mx|mw|mv|mu|mt|ms|mr|mq|mp|mo|mn|mm|ml|mk|mh|mg|mf|me|md|mc|ma|ly|lv|lu|lt|ls|lr|lk|li|lc|lb|la|kz|ky|kw|kr|kp|kn|km|ki|kh|kg|ke|jp|jo|jm|je|it|is|ir|iq|io|in|im|il|ie|id|hu|ht|hr|hn|hm|hk|gy|gw|gu|gt|gs|gr|gq|gp|gn|gm|gl|gi|gh|gg|gf|ge|gd|gb|ga|fr|fo|fm|fk|fj|fi|eu|et|es|er|eh|eg|ee|ec|dz|do|dm|dk|dj|de|cz|cy|cx|cw|cv|cu|cr|co|cn|cm|cl|ck|ci|ch|cg|cf|cd|cc|ca|bz|by|bw|bv|bt|bs|br|bq|bo|bn|bm|bl|bj|bi|bh|bg|bf|be|bd|bb|ba|az|ax|aw|au|at|as|ar|aq|ao|an|am|al|ai|ag|af|ae|ad|ac)(?=[^0-9a-zA-Z@+-]|$))")`,
	"twitter-text/regexen/validDomain.js": `#{validSubdomain}*#{validDomainName}(?:#{validGTLD}|#{validCCTLD}`,
	"twitter-text/regexen/validDomainChars.js": `/[^#{invalidDomainChars}]`,
	"twitter-text/regexen/validDomainName.js": `(/(?:(?:#{validDomainChars}(?:-|#{validDomainChars})*)?#{validDomainChars}`,
	"twitter-text/regexen/validGeneralUrlPathChars.js": `/[a-z#{cyrillicLettersAndMarks}0-9!\\*';:=\\+,\\.\\$\\/%#\\[\\]\\-\\u2013_`,
	"twitter-text/regexen/validGTLD.js": `pizza|pioneer|pink|ping|pin|pid|pictures|pictet|pics|piaget|physio|photos|photography|ph`,
	"twitter-text/regexen/validHashtag.js": `.default)(/(#{hashtagBoundary})(#{hashSigns})(?!\\uFE0F|\\u20E3)(#{hashtagAlphaNumeric}`,
	"twitter-text/regexen/validMentionOrList.js": `(#{validMentionPrecedingChars})(#{atSigns})([a-zA-Z0-9_]{1,20})(/[a-zA-Z][a-zA-Z0-9_-]{0,24})?`,
	"twitter-text/regexen/validMentionPrecedingChars.js": `/(?:^|[^a-zA-Z0-9_!#$%&*@＠]|(?:^|[^a-zA-Z0-9_+~.-])(?:rt|RT|rT|Rt):?)/`,
	"twitter-text/regexen/validPortNumber.js": `.default=/[0-9]+/`,
	"twitter-text/regexen/validPunycode.js": `/(?:xn--[\\-0-9a-z]+)/`,
	"twitter-text/regexen/validReply.js": `/^(?:#{spaces})*#{atSigns}([a-zA-Z0-9_]{1,20})`,
	"twitter-text/regexen/validSubdomain.js": `/(?:(?:#{validDomainChars}(?:[_-]|#{validDomainChars})*)?#{validDomainChars}`,
	"twitter-text/regexen/validTcoUrl.js": `https?:\\/\\/t\\.co\\/([a-z0-9]+)(?:\\?#{validUrlQueryChars}*#{validU`,
	"twitter-text/regexen/validUrlBalancedParens.js": `\\\\((?:#{validGeneralUrlPathChars}+|(?:#{validGeneralUrlPathChars}*\\\\(#{validGeneralUrlPathChars}+\\\\)#{validGeneralUrlPathChars}*))\\\\)`,
	"twitter-text/regexen/validUrlPath.js": `(?:(?:#{validGeneralUrlPathChars}*(?:#{validUrlBalancedParens}#{validGeneralUrlPathChars}*)*#{validUrlPathEndingChars})|(?:@#{validGeneralUrlPathChars}+/))`,
	"twitter-text/regexen/validUrlPathEndingChars.js": `/[\\+\\-a-z#{cyrillicLettersAndMarks}0-9=_#\\/#{latinAccentChars}]|(?:#{validUrlBalancedParens})/i`,
	"twitter-text/regexen/validUrlPrecedingChars.js": `^A-Za-z0-9@＠$#＃#{invalidCharsGroup}]|[#{directionalMarkersGroup}]|^`,
	"twitter-text/regexen/validUrlQueryChars.js": `/[a-z0-9!?\\*'@\\(\\);:&=\\+\\$\\/%#\\[\\]\\-_\\.,~|]/i`,
	"twitter-text/regexen/validUrlQueryEndingChars.js": `/[a-z0-9\\-_&=#\\/]/i`,
	...
	"tweetdeck/column_descriptions.js": `getColumnType=function(`,
	"tweetdeck/error_collection.js": `"tweetdeck_error_collection"`,
	"ui/base.js": `module.exports.uiBaseToReact=func`,
