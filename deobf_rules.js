...
exports.deobf_rules = {
	...
	"mustaches.account_selector_avatar.js": `<img src="{{profileImageURL}}" alt="{{_i}}{{screenName}}'s avatar{{/i}}"`,
	...
	"mustaches.account_summary_inline.js": `<img class="avatar size16 avatar-inline neg-margin-bxs" src="{{profileImageURL}}" alt="{{screenName}}\'s avatar"> @{{screenName}}`,
	...
	"mustaches.menus.filter_info_generic.js": `<div class="txt-size--11 padding-b--10 flex flex-row"> <div class="flex-shrink--0 margin-r--6"> <i class="icon icon-info icon-small"/> </div> <div> {{_i}} Your notification settings on <a rel="url noopener noreferrer" target="_blank"`,
	...
	"mustaches.menus.quality_filter_info.js": `<div class="txt-size--11 padding-b--10 flex flex-row"> <div class="flex-shrink--0 margin-r--6"> <i class="icon icon-info icon-small"/> </div> <div> <div class="txt-size--13">Quality filter {{qualityFilterText}}</div> {{_i}}Improves the quality of Tweets you\'ll see.{{/i}} <a rel="url noopener noreferrer" target="_blank" href="https://twitter.com/settings/notifications_timeline"> {{_i}}Update your preferences on Twitter.com{{/i}}`,
	...
	"mustaches.team_invitations.js": `<div class="padding-vxl"> <p class="color-twitter-gray txt-size--13 padding-hxl padding-bxl account-settings-bb"> {{_i}}You\'ve been invited to contribute to these Twitter accounts.{{/i}} <a href="https://support.twitter.com/articles/20171753-using-team-accounts-on-tweetdeck" target="_blank" rel="url noopener noreferrer">{{_i}}Learn more{{/i}}</a>. </p> {{#invitations}} <div class="js-account-settings-invited-row padding-vl padding-hxl position-rel account`,
	...
	"mustaches.text.already_registered.js": `{{_i}}There\'s already a TweetDeck account for that email address.{{/i}} <a href="#" data-action="forgotPassword">{{_i}}Want to recover your password?{{/i}}</a>`,
	"mustaches.text.b.js": `"<b>{{{content}}}</b>"`,
	"mustaches.text.br.js": `="<br>"`,
	"mustaches.text.close_em.js": `="</em>"`,
	"mustaches.text.close_strong.js": `="</strong>"`,
	...
	"mustaches.typeahead.typeahead_dropdown.js": `bbbbbbbbbbbbbbbbbb`,
