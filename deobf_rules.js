...
exports.deobf_rules = {
	...
	"strings/astralLetterAndMarks.js": `\\ud84b[\\udc00-\\udfff]|\\ud84c[\\udc00-\\udfff]|\\ud84d[\\udc00-\\udfff]|\\ud84e[\\udc00-\\udfff]|\\ud84f[\\udc00-\\udfff]|\\ud850`,
	"strings/astralNumerals.js": `\\ud801[\\udca0-\\udca9]|\\ud804[\\udc66-\\udc6f\\udcf0-\\udcf9\\udd36-\\udd3f\\uddd0-\\uddd9\\udef0-\\udef9]`,
	"strings/atSigns.js": `/[@＠]/`,
	"strings/bmpLetterAndMarks.js": `A-Za-z\\xaa\\xb5\\xba\\xc0-\\xd6\\xd8`,
	"strings/bmpNumerals.js": `0-9\\u0660-\\u0669\\u06f0-\\u06f9\\u07c0-\\u07c9`,
	"strings/cashtag.js": `[a-z]{1,6}(?:[._][a-z]{1,2})?`,
	"strings/codePoint.js": `(?:[^\\uD800-\\uDFFF]|[\\uD800-\\uDBFF][\\uDC00-\\uDFFF])`,
	"strings/cyrillicLettersAndMarks.js": `/\\u0400-\\u04FF/`,
	"strings/endHashtagMatch.js": `/^(?:#{hashSigns}|:\\/\\/)/,`,
	"strings/endMentionMatch.js": `?:#{atSigns}|[#{latinAccentChars}]`,
	"strings/extractUrl.js": `((#{validUrlPrecedingChars})((https?:`,
	"strings/hashSigns.js": `/[#＃]/`,
	"strings/hashtagAlpha.js": `(?:[#{bmpLetterAndMarks}]|`,
	"strings/hashtagAlphaNumeric.js": `[#{bmpLetterAndMarks}#{bmpNumerals}#{hashtagSpecialChars}]|(?=#{nonBmpCodePairs})(?:#{astralLetterAndMarks}|#{astralNumerals})`,
	"strings/hashtagBoundary.js": `?:^|\\uFE0E|\\uFE0F|$|`,
	"strings/hashtagSpecialChars.js": `\\u200c\\u200d\\ua67e\\u05be\\u05f3\\u05f4\\uff5e\\u301c\\u309b\\u309c\\u30a0\\u30fb\\u3003\\u0f0b\\u0f0c\\xb7`,
	"strings/invalidChars.js": `.default)(/[#{invalidCharsGroup}]/`,
	"strings/invalidCharsGroup.js": `exports.default=/\\uFFFE\\uFEFF\\uFFFF/`,
	"strings/invalidDomainChars.js": `#{punct}#{spacesGroup}#{invalidCharsGroup}#{directionalMarkersGroup}`,
	"strings/invalidUrlWithoutProtocolPrecedingChars.js": `exports.default=/[-_.\\/]$/`,
	"strings/latinAccentChars.js": `\\xC0-\\xD6\\xD8-\\xF6\\xF8-\\xFF\\u0100-\\u024F\\u0253\\u0254\\u0256\\u0257\\u0259\\u025B\\u0263\\u0268\\u026F\\u0272\\u0289\\u028B\\u02BB\\u0300-\\u036F\\u1E00`,
	"strings/nonBmpCodePairs.js": `/[\\uD800-\\uDBFF][\\uDC00-\\uDFFF]/gm`,
	"strings/punct.js": `/\\!'#%&'\\(\\)*\\+,\\\\\\-\\.\\/:;<=>\\?@\\[\\]\\^_{|}~\\$/`,
	"strings/rtlChars.js": `[\\u0600-\\u06FF]|[\\u0750-\\u077F]|[\\u0590-\\u05FF]|[\\uFE70-\\uFEFF]`,
	"strings/spaces.js": `.default)(/[#{spacesGroup}]/`,
	"strings/spacesGroup.js": `\\x09-\\x0D\\x20\\x85\\xA0\\u1680\\u180E\\u2000-\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000`,
	"strings/urlHasHttps.js": `/^https:\\/\\//i`,
	"strings/urlHasProtocol.js": `/^https?:\\/\\//i`,
	"strings/validAsciiDomain.js": `(?:[0-9]|(?:[1-9][0-9])|(?:1[0-9]{2})|(?:2[0-4][0-9])|(?:25[0-5]))/`,
	// "strings/validateUrlAuthority.js": ``,
	"strings/validateUrlDecOctet.js": `/(?:(?:#{validateUrlSubDomainSegment}\\.)*(?:#{validateUrlDomainSegment}\\.)#{validateUrlDomainTld})/i`,
	"strings/validateUrlDomain.js": `/(?:[a-z0-9](?:[a-z0-9\\-]*[a-z0-9])?)/i`,
	"strings/validateUrlDomainSegment.js": `/(?:[a-z](?:[a-z0-9\\-]*[a-z0-9])?)/i`,
	"strings/validateUrlDomainTld.js": `.default)(/(#{validateUrlPchar}|\\/|\\?)*/i`,
	"strings/validateUrlFragment.js": `.default)("(?:#{validateUrlIp}|#{validateUrlDomain})",`,
	"strings/validateUrlHost.js": `.default)("(?:#{validateUrlIpv4}|#{validateUrlIpv6})"`,
	"strings/validateUrlIp.js": `.default)(/(?:#{validateUrlDecOctet}(?:\\.#{validateUrlDecOctet}){3})/i`,
	"strings/validateUrlIpv4.js": `/(?:\\[[a-f0-9:\\.]+\\])/i`,
	"strings/validateUrlIpv6.js": `.default)(/(\\/#{validateUrlPchar}*)*/i`,
	"strings/validateUrlPath.js": `.default)("(?:#{validateUrlUnreserved}|#{validateUrlPctEncoded}|#{validateUrlSubDelims}|[:|@])"`,
	"strings/validateUrlPchar.js": `/(?:%[0-9a-f]{2})/i`,
	"strings/validateUrlPctEncoded.js": `.default=/[0-9]{1,5}/`,
	"strings/validateUrlPort.js": `.default)(/(#{validateUrlPchar}|\\/|\\?)*/i`,
	"strings/validateUrlQuery.js": `.default=/(?:[a-z][a-z0-9+\\-.]*)/i`,
	"strings/validateUrlScheme.js": `.default=/[!$&'()*+,;=]/i`,
	"strings/validateUrlSubDelims.js": `/(?:[a-z0-9](?:[a-z0-9_\\-]*[a-z0-9])?)/i`,
	"strings/validateUrlSubDomainSegment.js": `("^(?:([^:/?#]+):\\\\/\\\\/)?([^/?#]*)([^?#]*)(?`,
	"strings/validateUrlUnencoded.js": `"(?:(#{validateUrlUserinfo})@)?(#{validateUrlUnicodeHost})(?::(#{validateUrlPort}))?"`,
	"strings/validateUrlUnicodeAuthority.js": `.default)(/(?:(?:#{validateUrlUnicodeSubDomainSegment}`,
	"strings/validateUrlUnicodeDomain.js": `(?:(?:[a-z0-9]|[^\\u0000-\\u007f])(?:(?:[a-z0-9\\-]|[^\\u00`,
	"strings/validateUrlUnicodeDomainSegment.js": `exports.default=/(?:(?:[a-z0-9]|[^\\u0000-\\u007f])(?:(?:[a-z0-9\\-]|[^\\u0000-\\u007f])*(?:[a-z0-9]|[^\\u0000-\\u007f]))?)/i,module.exports=exports.default`,
	"strings/validateUrlUnicodeDomainTld.js": `.default)("(?:#{validateUrlIp}|#{validateUrlUnicodeDomain})"`,
	"strings/validateUrlUnicodeHost.js": `/(?:(?:[a-z0-9]|[^\\u0000-\\u007f])(?:(?:[a-z0-9`,
	"strings/validateUrlUnicodeSubDomainSegment.js": `.default=/[a-z\\u0400-\\u04FF0-9\\-._~]/i`,
	"strings/validateUrlUnreserved.js": `.default)("(?:#{validateUrlUnreserved}|#{validateUrlPctEncoded}|#{validateUrlSubDelims}|:)*"`,
	"strings/validateUrlUserinfo.js": `/(?:(?:[\\-a-z0-9#{latinAccentChars}]+)\\.)+(?:#{validGTLD}|#{validCCTLD}|#{validPunycode})/gi`,
	"strings/validCashtag.js": `.default)("(^|#{spaces})(\\\\$)(#{cashtag})(?=$|\\\\s|[#{punct}])"`,
	"strings/validCCTLD.js": `"(?:(?:한국|香港|澳門|新加坡|台灣|台湾|中國|中国|გე|ไทย|ලංකා|ഭാരതം|ಭಾರತ|భారత్|சிங்கப்பூர்|இலங்கை|இந்தியா|ଭାରତ|ભારત|ਭਾਰਤ|ভাৰত|ভারত|বাংলা|भारोत|भारतम्|भारत|ڀارت|پاکستان|موريتانيا|مليسيا|مصر|قطر|فلسطين|عمان|عراق|سورية|سودان|تونس|بھارت|بارت|ایران|امارات|المغرب|السعودية|الجزائر|الاردن|հայ|қаз|укр|срб|рф|мон|мкд|ею|бел|бг|ελ|zw|zm|za|yt|ye|ws|wf|vu|vn|vi|vg|ve|vc|va|uz|uy|us|um|uk|ug|ua|tz|tw|tv|tt|tr|tp|to|tn|tm|tl|tk|tj|th|tg|tf|td|tc|sz|sy|sx|sv|su|st|ss|sr|so|sn|sm|sl|sk|sj|si|sh|sg|se|sd|sc|sb|sa|rw|ru|rs|ro|re|qa|py|pw|pt|ps|pr|pn|pm|pl|pk|ph|pg|pf|pe|pa|om|nz|nu|nr|np|no|nl|ni|ng|nf|ne|nc|na|mz|my|mx|mw|mv|mu|mt|ms|mr|mq|mp|mo|mn|mm|ml|mk|mh|mg|mf|me|md|mc|ma|ly|lv|lu|lt|ls|lr|lk|li|lc|lb|la|kz|ky|kw|kr|kp|kn|km|ki|kh|kg|ke|jp|jo|jm|je|it|is|ir|iq|io|in|im|il|ie|id|hu|ht|hr|hn|hm|hk|gy|gw|gu|gt|gs|gr|gq|gp|gn|gm|gl|gi|gh|gg|gf|ge|gd|gb|ga|fr|fo|fm|fk|fj|fi|eu|et|es|er|eh|eg|ee|ec|dz|do|dm|dk|dj|de|cz|cy|cx|cw|cv|cu|cr|co|cn|cm|cl|ck|ci|ch|cg|cf|cd|cc|ca|bz|by|bw|bv|bt|bs|br|bq|bo|bn|bm|bl|bj|bi|bh|bg|bf|be|bd|bb|ba|az|ax|aw|au|at|as|ar|aq|ao|an|am|al|ai|ag|af|ae|ad|ac)(?=[^0-9a-zA-Z@+-]|$))")`,
	"strings/validDomain.js": `#{validSubdomain}*#{validDomainName}(?:#{validGTLD}|#{validCCTLD}`,
	"strings/validDomainChars.js": `/[^#{invalidDomainChars}]`,
	"strings/validDomainName.js": `(/(?:(?:#{validDomainChars}(?:-|#{validDomainChars})*)?#{validDomainChars}`,
	"strings/validGeneralUrlPathChars.js": `/[a-z#{cyrillicLettersAndMarks}0-9!\\*';:=\\+,\\.\\$\\/%#\\[\\]\\-\\u2013_`,
	"strings/validGTLD.js": `pizza|pioneer|pink|ping|pin|pid|pictures|pictet|pics|piaget|physio|photos|photography|ph`,
	"strings/validHashtag.js": `.default)(/(#{hashtagBoundary})(#{hashSigns})(?!\\uFE0F|\\u20E3)(#{hashtagAlphaNumeric}`,
	"strings/validMentionOrList.js": `(#{validMentionPrecedingChars})(#{atSigns})([a-zA-Z0-9_]{1,20})(/[a-zA-Z][a-zA-Z0-9_-]{0,24})?`,
	"strings/validMentionPrecedingChars.js": `/(?:^|[^a-zA-Z0-9_!#$%&*@＠]|(?:^|[^a-zA-Z0-9_+~.-])(?:rt|RT|rT|Rt):?)/`,
	"strings/validPortNumber.js": `.default=/[0-9]+/`,
	"strings/validPunycode.js": `/(?:xn--[\\-0-9a-z]+)/`,
	"strings/validReply.js": `/^(?:#{spaces})*#{atSigns}([a-zA-Z0-9_]{1,20})`,
	"strings/validSubdomain.js": `/(?:(?:#{validDomainChars}(?:[_-]|#{validDomainChars})*)?#{validDomainChars}`,
	"strings/validTcoUrl.js": `https?:\\/\\/t\\.co\\/([a-z0-9]+)(?:\\?#{validUrlQueryChars}*#{validU`,
	"strings/validUrlBalancedParens.js": `\\\\((?:#{validGeneralUrlPathChars}+|(?:#{validGeneralUrlPathChars}*\\\\(#{validGeneralUrlPathChars}+\\\\)#{validGeneralUrlPathChars}*))\\\\)`,
	"strings/validUrlPath.js": `(?:(?:#{validGeneralUrlPathChars}*(?:#{validUrlBalancedParens}#{validGeneralUrlPathChars}*)*#{validUrlPathEndingChars})|(?:@#{validGeneralUrlPathChars}+/))`,
	"strings/validUrlPathEndingChars.js": `/[\\+\\-a-z#{cyrillicLettersAndMarks}0-9=_#\\/#{latinAccentChars}]|(?:#{validUrlBalancedParens})/i`,
	"strings/validUrlPrecedingChars.js": `^A-Za-z0-9@＠$#＃#{invalidCharsGroup}]|[#{directionalMarkersGroup}]|^`,
	"strings/validUrlQueryChars.js": `/[a-z0-9!?\\*'@\\(\\);:&=\\+\\$\\/%#\\[\\]\\-_\\.,~|]/i`,
	"strings/validUrlQueryEndingChars.js": `/[a-z0-9\\-_&=#\\/]/i`,
