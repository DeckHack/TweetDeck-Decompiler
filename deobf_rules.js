...
exports.deobf_rules = {
	...
	"mustaches.menus.filter_info_generic.js": `href="https://twitter.com/settings/notifications_timeline"> {{_i}}Update your preferences on Twitter.com{{/i}} </a> </div> </div>`,
	...
	"mustaches.menus.quality_filter_info.js": `Quality filter {{qualityFilterText}}</div> {{_i}}Improves the quality of Tweets you\\'ll see.{{/i}} <a rel="url noopener noreferrer" target="_blank" href="https://twitter.com/settings/notificatio`,
